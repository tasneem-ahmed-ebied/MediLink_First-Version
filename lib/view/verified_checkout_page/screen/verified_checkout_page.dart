...
class VerifiedCheckOutPage extends StatelessWidget {
  const VerifiedCheckOutPage({super.key});
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        Utils.yourCheckOutHasBeenVerified,style: TextStyle(fontSize: FontSizeManagers.f10,color: ColorManager.grey,),),
                      SizedBox(height: HeightManager.h20,),
                      InkWell(
                        onTap: () => Navigator.pushNamed(context, RoutesNames.homeUserPage),
                        child: Container(
